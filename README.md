...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [ForgeRelay](https://github.com/ForgeRelay) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for ForgeRelay.
...
```bash
git clone https://github.com/ForgeRelay/core
cd core
go mod download
```
...
- **GitHub Issues:** [github.com/ForgeRelay/issues](https://github.com/ForgeRelay)
- **Discussions:** [github.com/ForgeRelay/discussions](https://github.com/ForgeRelay)
